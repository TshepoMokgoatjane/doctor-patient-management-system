package za.co.doctorpatient.management.system.servlet.controller;
...
public class DoctorServletController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DoctorServletController() {
        super();
